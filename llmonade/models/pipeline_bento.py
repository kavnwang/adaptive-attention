...
from llmonade.models.parallelize_bento import get_blocks, get_components_name, get_model
...
def pipeline_bento(
    ...
    stages, models = pipeline_bento_manual_split(
...
def pipeline_bento_manual_split(
